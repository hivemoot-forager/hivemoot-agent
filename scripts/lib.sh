...
# resolve_effective_auth_mode() → lib-validate.sh
...
# repo_name_is_valid() → lib-validate.sh
...
# validate_target_repo() → lib-validate.sh
# validate_workspace_root() → lib-validate.sh
...
# validate_agent_id() → lib-validate.sh
# task_id_is_valid() → lib-validate.sh
# validate_task_id() → lib-validate.sh
...
# preflight_check_provider_auth() → lib-validate.sh
